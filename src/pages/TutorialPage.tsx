    ...
    <div className="min-h-screen relative">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-8 relative z-10">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[rgba(255, 69, 0,0.08)] border border-[rgba(255, 69, 0,0.15)] flex items-center justify-center">
        ...
        {script && (
          <div className="glass-panel p-6 sm:p-8">
            <h2 className="text-xs font-bold text-[#FF4500] uppercase tracking-wider mb-4">
              Written Guide
            </h2>
            <div
              className="prose prose-invert prose-sm max-w-none text-[#94a3b8] [&_a]:text-[#FF4500] [&_a]:underline [&_h1]:text-[#E2E8F0] [&_h2]:text-[#E2E8F0] [&_h3]:text-[#E2E8F0] [&_strong]:text-[#E2E8F0] [&_code]:text-[#FF4500] [&_code]:bg-[rgba(255, 69, 0,0.08)] [&_code]:px-1 [&_code]:rounded"
