      ...
      <div className="p-6 sm:p-8 space-y-5">
        ...
        {features.length > 0 && (
          <div className="pt-2 space-y-1.5">
            <h3 className="text-xs font-bold text-[#FF4500] uppercase tracking-wider mb-2">Features</h3>
        ...
        <div className="flex flex-wrap items-center gap-4 pt-2">
          ...
          {ratingCount > 0 && (
            <span className="inline-flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full bg-[rgba(245, 158, 11,0.10)] border border-[rgba(245, 158, 11,0.30)] text-[#F59E0B]">
              <Star className="w-3 h-3 fill-[#F59E0B]" /> {ratingAvg.toFixed(1)} ★
        ...
        {mod.changelog && (
          <div className="pt-4 border-t border-[rgba(255,255,255,0.06)]">
            <h3 className="text-xs font-bold text-[#FF4500] uppercase tracking-wider mb-2">Changelog</h3>
        ...
        {mod.videoUrl && (
          <div className="pt-4 border-t border-[rgba(255,255,255,0.06)]">
            <h3 className="text-xs font-bold text-[#FF4500] uppercase tracking-wider mb-3">Preview</h3>
