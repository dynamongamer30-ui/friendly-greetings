  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      confetti({
        ...
        spread: 70,
        origin: { y: 0.6 },
        colors: ['#FFD700', '#00F0FF', '#a855f7', '#fff'],
        scalar: 0.8,
        gravity: 1.2,
      })
    ...
    <div className="space-y-2">
      <div className="flex items-center gap-3">
              ...
              >
                <svg viewBox="0 0 24 24" style={{ width: 28, height: 28 }} aria-hidden="true">
                  <path
                    ...
                    stroke={filled ? '#FFD700' : 'rgba(255,215,0,0.45)'}
                    strokeWidth="1.4"
        ...
        {locked ? (
          ...
          <span className="text-xs text-[#FFD700] font-semibold">{LABELS[pendingRating]}</span>
        ) : (
      ...
      {pendingRating !== null && (
        <div
          ...
          style={{ borderColor: 'rgba(255,215,0,0.25)', borderRadius: 14 }}
        >
