      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1">
          <Search
            ...
            style={{ color: focused ? '#00F0FF' : '#475569' }}
          />
          <input
            type="text"
            value={searchTerm}
            ...
            style={{
              ...
              boxShadow: focused
                ? '0 0 0 1px rgba(0,240,255,0.5), 0 0 20px rgba(0,240,255,0.15), inset 0 0 20px rgba(0,240,255,0.03)'
                : undefined,
              borderColor: focused ? 'rgba(0,240,255,0.5)' : undefined,
        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            style={{
              ...
              color: category === cat ? '#00F0FF' : '#94a3b8',
              background: category === cat
                ? 'rgba(0,240,255,0.12)'
                : 'rgba(255,255,255,0.04)',
              boxShadow: category === cat
                ? '0 0 14px rgba(0,240,255,0.12), inset 0 0 12px rgba(0,240,255,0.05)'
                : 'none',
            ...
            {category === cat && (
              <span
                ...
                style={{
                  position: 'absolute',
                  inset: 0,
                  background: 'radial-gradient(circle at 50% 120%, rgba(0,240,255,0.18) 0%, transparent 70%)',
