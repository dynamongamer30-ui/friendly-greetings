...
export function AnnouncementBanner({ message, onDismiss }: AnnouncementBannerProps) {
  return (
    <div className="relative w-full bg-[rgba(8,12,20,0.85)] border-b border-[rgba(0,240,255,0.10)] backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-3 py-2 flex items-center gap-2.5">
        <Megaphone className="w-3.5 h-3.5 text-[#00F0FF] shrink-0 opacity-80" />
