  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: '0 0 24px rgba(255, 69, 0,0.12), 0 8px 32px rgba(0,0,0,0.5)',
    ...
    >
      <div style={{
        ...
        <Trophy size={18} color="#FF4500" />
      </div>

      <div>
        <div style={{
          fontSize: 10, color: '#FF4500', fontWeight: 700,
      ...
      <div style={{
        ...
        background: 'rgba(255, 69, 0,0.15)', overflow: 'hidden',
      }}>
        <div style={{
