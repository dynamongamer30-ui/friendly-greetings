      ...
      >
        <svg viewBox="0 0 120 120" width="96" height="96" fill="none">
          ...
          <g style={{ transformOrigin: '73px 53px', animation: 'es-spin-rev 11s linear infinite' }}>
            <rect x="62" y="42" width="22" height="22" rx="5" stroke="#F59E0B" strokeWidth="2" />
          </g>

          {/* Floating triangle */}
          <g style={{ animation: 'es-float 3.6s ease-in-out infinite' }}>
            <path d="M30 80 L50 70 L48 92 Z" stroke="#FF4500" strokeWidth="2" strokeLinejoin="round" />
          </g>

          {/* Pulsing dot */}
          <circle cx="80" cy="80" r="6" fill="#FF4500" fillOpacity="0.5">
